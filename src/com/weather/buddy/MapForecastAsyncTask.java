...
public class MapForecastAsyncTask extends AsyncTask<Double, String, String> {

	private ForecastMapActivity callingActivity;
	
	public MapForecastAsyncTask(ForecastMapActivity acivity) {
	...
	protected String doInBackground(Double... params) {
       ...
       HttpPost httppost = new HttpPost("http://10.0.2.2/cpb/index.php/rainForecastForAndroid");
