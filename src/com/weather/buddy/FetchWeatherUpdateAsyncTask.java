...
public class FetchWeatherUpdateAsyncTask extends AsyncTask<Double, String, String> {

	private WeatherUpdateActivity callingActivity;
	
	public FetchWeatherUpdateAsyncTask(WeatherUpdateActivity acivity) {
	...
	protected void onPreExecute() {
		...
		super.onPreExecute();
		callingActivity.showProcessDialog("Downloading Weather Update!");
	}
